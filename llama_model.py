...
#     print('\n\n\n\n')
    ndim = x.ndim
    assert 0 <= 1 < ndim
    if freqs_cis.shape[0] == x.shape[1] + 1:
        freqs_cis = freqs_cis[:-1, :]
#         print(freqs_cis.shape, x.shape, 'p1')
#     else:
#         print(freqs_cis.shape, x.shape, 'p2')
...
class Attention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, mask: Optional[torch.Tensor]):
        ...
        device = xq.device
        freqs_cis_current = freqs_cis.to(device)
